...
<div class="card">
  ...
  <form action="<?= base_url('index.php/welcome/update/').$barang['id']; ?>" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="ket" name="ket" placeholder="Keterangan Barang" required="" value="<?= $barang['ket']; ?>">
  </div>
